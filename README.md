...
| [A2GC: Asymmetric Aggregation with Geometric Constraints for Locally Aggregated Descriptors](https://arxiv.org/pdf/2511.14109) | Zhenyu Li | arxiv 2025 | [Github](https://github.com/CV4RA/A2GC) | [BibTex](citations/li20252.txt)
| [FourierPlace: A Vision-Language Localization Framework Based on Frequency Domain Representations](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=11260932) | Tianyi Shang | IEEE RAL 2025| [Github](https://github.com/nuozimiaowu/FourierPlace) | [BibTex](shang2025fourierplace.txt)
